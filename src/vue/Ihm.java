...
public class Ihm {
	...
	private void initialize() {
		...
		btnNewButton.setBounds(486, 330, 109, 33);
		frame.getContentPane().add(btnNewButton);
		
		textField = new JTextField();
		textField.setBounds(0, 331, 476, 32);
		...
		JButton btnNewButton_1 = new JButton("G\u00E9rer le compte");
		btnNewButton_1.setBounds(605, 330, 131, 33);
